...
"""
from common import singleton, get_payload_from_token, get_now_ts, decrypt_user_id, constant
import common
            ...
            try:
                ...
                if handler.user_payload:
                    if 'ext' in handler.user_payload:
                        handler.user_type = handler.user_payload['ext'].get('t', constant.USER_TYPE['SINGLE'])
